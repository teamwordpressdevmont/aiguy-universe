...
class BlogCategoryController extends Controller
{
    ...
    public function addEdit() {
        ...
        return view('blog-category.add-edit', compact('allCategories'));
    ...
    public function list(Request $request) {
        ...
        if ($request->ajax()) {
            return response()->json([
                'html' => view('blog-category.list', compact('categories'))->render(),
                'pagination' => (string) $categories->appends($request->all())->links()
            ]);
        }

        return view('blog-category.list', compact('categories', 'search', 'sortBy', 'sortDirection'));
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            if ($request->hasFile('icon')) {
                ...
                $imageName = 'blog_cateogry_icon_' . $formattedDate . '.' . $extension;
                $leftImagePath = $image->storeAs('blog-category-images', $imageName, 'public');
            ...
            DB::commit();
            return redirect()->route('blog.categories.list')->with('success', 'Category created successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->with('error', 'Failed to Category: ' . $e->getMessage());
        }        
    ...
    // Display the form for editing a category
     public function edit($id) {
        ...
        return view('blog-category.add-edit', compact('category', 'allCategories')); // Pass both to the view
     }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('blog.categories.list')->with('success', 'Category updated successfully.'); // Redirect with success message
    ...
    public function destroy($id) {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('blog.categories.list')->with('success', 'Category deleted successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
