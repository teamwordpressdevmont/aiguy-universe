...
@section('content')
    ...
    @endif
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Single Collection Data</h1>
        </div>
        <div class="bg-white border rounded-xl shadow-sm sm:flex mb-5">
            <div class="p-4 flex flex-col h-full sm:p-7">
                <h3 class="text-lg font-bold text-default-800 mb-2">
                    <strong>Collection Name:</strong>  {{$folder->folder_name}}
                </h3>
